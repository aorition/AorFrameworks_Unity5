...
namespace UnityEngine.UI
{
    ...
    public class UGUI_ScrollRect_SC : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
