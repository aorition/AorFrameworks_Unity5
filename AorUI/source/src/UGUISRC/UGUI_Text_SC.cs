...
namespace UnityEngine.UI
{
    ...
    public class UGUI_Text_SC : MaskableGraphic, ILayoutElement
    {
        [SerializeField]
        ...
        public Font font
        {
            ...
            set
            {
                ...
                UGUI_FontUpdateTracker_SC.UntrackText(this);

                m_FontData.font = value;

                UGUI_FontUpdateTracker_SC.TrackText(this);
        ...
        /// **** src Hack 
        /// 
        /// 为子组件重写OnPopulateMesh方法提供接口
        /// </summary>
        /// <param name="toFill"></param>
        protected virtual void OnPopulateMeshDo(VertexHelper toFill)
        {
