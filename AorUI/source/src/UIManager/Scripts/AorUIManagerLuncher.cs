...
namespace Framework.UI
{
    ...
    /// 
    /// </summary>
    public class AorUIManagerLuncher : MonoBehaviour
    {
        [SerializeField]
...
//            GraphicsManager.GetInstance(ParentTransformPovit, DonDestroyOnLoad);
            AorUIManager.GetInstance(ParentTransformPovit, DonDestroyOnLoad);
            onUIManagerInstanced();

            AorUIManager.instance.setup(_UIManagerSetting);
