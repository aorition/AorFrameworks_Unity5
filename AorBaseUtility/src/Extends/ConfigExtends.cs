...
namespace AorBaseUtility
{
    ...
    public static class ConfigExtends
    {
        ...
        public static T updateConfigValues<T>(this T cfgInst, Dictionary<string, object> updateValues) where T : Config.Config
        {
        ...
        /// <returns>更新后的配置数据实例</returns>
        public static T updateConfigValue<T>(this T cfgInst, string key, object value) where T : Config.Config
        {
            Type t = cfgInst.GetType();
