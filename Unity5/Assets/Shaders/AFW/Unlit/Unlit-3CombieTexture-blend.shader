...
//<readonly>T4M 3通道 + BlendColor support：<LightMap><Fog><Shadow>
//@@@DynamicShaderInfoEnd
Shader "AFW/Unlit/Unlit - 3CombieTexture - blend" 
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (a2v v)
			{
				...
				o.uv3 = TRANSFORM_TEX(v.texcoord, _Blend);
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				fixed4 blend = tex2D(_Blend, i.uv3.xy);

				fixed3 col = (lay1.xyz * Mask.r + lay2.xyz * Mask.g + lay3.xyz * Mask.b) * blend.rgb;
				fixed alpha =(lay1.w * Mask.r + lay2.w * Mask.g + lay3.w * Mask.b) * blend.a * _TintColor;
