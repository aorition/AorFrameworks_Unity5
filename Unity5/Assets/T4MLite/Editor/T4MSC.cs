...
namespace T4MLite
{
    ...
    public class T4MSC : EditorWindow
    {
        ...
        static public ViewD[] ViewDistance =
        {
            ViewD.Middle, ViewD.Middle, ViewD.Middle, ViewD.Middle, ViewD.Middle,
            ViewD.Middle
        };
        ...
        enum EnumShaderGLES2
        {
            ...
            T4M_2_Textures_4_MobileVertex, //add by sha
            T4M_3_Textures_4_MobileVertex, //add by sha
            T4M_4_Textures_4_MobileVertex, //add by sha
...
//        Transform PlayerCam;
        ...
        //aorition hacked
        static public bool T4MUseOverrideColor;
        static public Color T4MoverrideColor = Color.white;
        static public Texture2D T4MOColorTex;
        ...
        string T4MEditorFolder = "Assets/T4MLite/Editor/";
        string T4MFolder = "Assets/T4MLite/";
        ...
        void OnGUI()
        {
            ...
            if (CurrentSelect != null && T4MActived == "Activated")
            {
                ...
                if (CurrentSelect.GetComponent<T4MObjSC>() &&
                    (!CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial ||
                     !CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMesh))
                {

                    if (rendererPart.Length == 0)
                    {
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial =
                            CurrentSelect.GetComponent<Renderer>().sharedMaterial;
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMesh =
                    ...
                    else
                    {
                        for (int i = 0; i < rendererPart.Length; i++)
                        {
                            ...
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMesh =
                                rendererPart[0].gameObject.GetComponent<MeshFilter>();
                        }
                    }
                }
                else if (CurrentSelect.GetComponent<T4MObjSC>() &&
                         CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial)
                {
                    if (nbrT4MObj == 1 && CurrentSelect.GetComponent<T4MObjSC>().Master != 1)
                        T4MMaster = false;
                    else if (nbrT4MObj == 1 && CurrentSelect.GetComponent<T4MObjSC>().Master == 1 &&
                             T4MMaster == false && initMaster == false)
                    {
                        T4MMaster = true;
                        initMaster = true;
                    }
                    if (rendererPart.Length == 0)
                    {
                        if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial !=
                            CurrentSelect.GetComponent<Renderer>().sharedMaterial)
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial =
                                CurrentSelect.GetComponent<Renderer>().sharedMaterial;
        ...
        void BillboardMenu()
        {
            ...
            {
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial &&
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat0") &&
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat1") &&
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control"))
                {
        ...
        void BillboardCreator()
        {
            ...
            if (GUILayout.Button("CONSTRUCT", GUILayout.Width(100), GUILayout.Height(30)))
            {
                if (PrefabName != "" && LOD1Material)
                    ...
                    EditorUtility.DisplayDialog("T4M Message",
                        "You must complete the formulary before make the construct", "OK");
            }
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            GUILayout.FlexibleSpace();
        ...
        void CreatePrefabBB()
        {
            ...
            do
            {
                ...
                {
                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPrefabFolder + "BillBObjects/Material/" + PrefabName + ".mat");

                    BasePrefab =
                        PrefabUtility.CreateEmptyPrefab(T4MPrefabFolder + "BillBObjects/" + PrefabName + ".prefab");
                ...
                else if (!System.IO.File.Exists(T4MPrefabFolder + "BillBObjects/" + Next + ".prefab"))
                {
                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPrefabFolder + "BillBObjects/Material/" + Next + ".mat");
...
//        }
        ...
        void Planting()
        {
            if (CurrentSelect.GetComponent<T4MObjSC>())
            {
                    ...
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control"))
                {
                    ...
                    GUILayout.BeginHorizontal("box");
                    GUILayout.FlexibleSpace();
                    T4MPlantSel = GUILayout.SelectionGrid(T4MPlantSel, TexObject, 6, "gridlist", GUILayout.Width(340),
                        GUILayout.Height(58));
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                    ...
                    if (intialized)
                    {
                        ...
                        if (TexTexture.Length > 4)
                            T4MselTexture = GUILayout.SelectionGrid(T4MselTexture, TexTexture, 6, "gridlist",
                                GUILayout.Width(340), GUILayout.Height(58));
                        else
                            T4MselTexture = GUILayout.SelectionGrid(T4MselTexture, TexTexture, 4, "gridlist",
                                GUILayout.Width(340), GUILayout.Height(86));
                        GUILayout.FlexibleSpace();
                        GUILayout.EndHorizontal();
                        GUILayout.FlexibleSpace();
                        GUILayout.EndHorizontal();
                        ...
                        if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_SpecColor"))
                        {
                            ...
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                .T4MMaterial.SetColor("_SpecColor", ShinessColor);
                            EditorGUILayout.Space();
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                .T4MMaterial.HasProperty("_ShininessL0"))
                            {
                                shiness0 = EditorGUILayout.Slider("Shininess Layer 1", shiness0, 0.00f, 1.0f);
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetFloat("_ShininessL0", shiness0);
                            }
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                .T4MMaterial.HasProperty("_ShininessL1"))
                            {
                                shiness1 = EditorGUILayout.Slider("Shininess Layer 2", shiness1, 0.00f, 1.0f);
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetFloat("_ShininessL1", shiness1);
                            }
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                .T4MMaterial.HasProperty("_ShininessL2"))
                            {
                                shiness2 = EditorGUILayout.Slider("Shininess Layer 3", shiness2, 0.00f, 1.0f);
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetFloat("_ShininessL2", shiness2);
                            }
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                .T4MMaterial.HasProperty("_ShininessL3"))
                            {
                                shiness3 = EditorGUILayout.Slider("Shininess Layer 4", shiness3, 0.00f, 1.0f);
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetFloat("_ShininessL3", shiness3);
                            }
                        ...
                        if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_SpecColor"))
                        {
                            scrollPos = EditorGUILayout.BeginScrollView(scrollPos, GUILayout.Width(350),
                        ...
                        else
                        {
                            GUILayout.BeginVertical("box", GUILayout.Width(320));
                            if (TexTexture.Length > 4)
                                scrollPos = EditorGUILayout.BeginScrollView(scrollPos, GUILayout.Width(340),
                                    GUILayout.Height(275));
                            else
                                scrollPos = EditorGUILayout.BeginScrollView(scrollPos, GUILayout.Width(340),
                        ...
                        if (joinTiles)
                        {
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat3"))
                            {
                                ...
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetVector("_Tiling3", new Vector4(Layer4Tile.x, Layer4Tile.x, 0, 0));
                            }
                            EditorGUILayout.Space();
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat4"))
                            {
                                ...
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetVector("_Tiling4", new Vector4(Layer5Tile.x, Layer5Tile.x, 0, 0));
                            }
                            EditorGUILayout.Space();
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat5"))
                            {
                                ...
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetVector("_Tiling5", new Vector4(Layer6Tile.x, Layer6Tile.x, 0, 0));
                            }
                        }
                        else
                        {
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat3"))
                            {
                                ...
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetVector("_Tiling3", new Vector4(Layer4Tile.x, Layer4Tile.y, 0, 0));
                            }
                            EditorGUILayout.Space();
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat4"))
                            {
                                ...
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetVector("_Tiling4", new Vector4(Layer5Tile.x, Layer5Tile.y, 0, 0));
                            }
                            EditorGUILayout.Space();
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat5"))
                            {
                                ...
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                    .T4MMaterial.SetVector("_Tiling5", new Vector4(Layer6Tile.x, Layer6Tile.y, 0, 0));
                            }
                        }
                        ...
                        if (selBrush != oldSelBrush || T4MBrushSizeInPourcent != oldBrushSizeInPourcent ||
                            T4MBrushAlpha == null || T4MselTexture != oldselTexture)
                        {
                            if (T4MselTexture == 0)
                            {
                                T4MPreview.material.SetTexture("_MainTex",
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat0")
                                        as Texture);
                            ...
                            {
                                T4MPreview.material.SetTexture("_MainTex",
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat1")
                                        as Texture);
                                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                                    Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures Auto BeastLM 2DrawCall") ||
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                                    Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures ManualAdd BeastLM_1DC") ||
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                                    Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures ManualAdd CustoLM 1DC"))
                            ...
                            {
                                T4MPreview.material.SetTexture("_MainTex",
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat2")
                                        as Texture);
                            ...
                            {
                                T4MPreview.material.SetTexture("_MainTex",
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat3")
                                        as Texture);
                                T4MtargetColor = new Color(0, 0, 0, 1);
                                if (T4MMaskTex2)
                            ...
                            {
                                T4MPreview.material.SetTexture("_MainTex",
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat4")
                                        as Texture);
                                T4MtargetColor = new Color(0, 0, 0, 1);
                                if (T4MMaskTex2)
                            ...
                            {
                                T4MPreview.material.SetTexture("_MainTex",
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat5")
                                        as Texture);
                                T4MtargetColor = new Color(0, 0, 0, 1);
                                if (T4MMaskTex2)
        ...
        static public void SaveTexture()
        {
            ...
            if (T4MOColorTex)
            {
                var path3 = AssetDatabase.GetAssetPath(T4MOColorTex);
                var bytes3 = T4MOColorTex.EncodeToPNG();
        ...
        void CreatePrefab()
        {
            ...
            do
            {
                ...
                if (!System.IO.File.Exists(T4MPrefabFolder + "LODObjects/" + PrefabName + "_LOD.prefab"))
                {
                    ...
                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPrefabFolder + "LODObjects/Material/" + PrefabName + "LOD1.mat");
                    if (ShaderLOD2S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD2Material,
                            T4MPrefabFolder + "LODObjects/Material/" + PrefabName + "LOD2.mat");
                    if (ShaderLOD3S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD3Material,
                            T4MPrefabFolder + "LODObjects/Material/" + PrefabName + "LOD3.mat");
                    BasePrefab =
                        PrefabUtility.CreateEmptyPrefab(T4MPrefabFolder + "LODObjects/" + PrefabName + ".prefab");
                    PrefabUtility.ReplacePrefab(LOD1Temp, BasePrefab);
                    ExportSuccess = true;
                }
                else if (!System.IO.File.Exists(T4MPrefabFolder + "LODObjects/" + Next + "_LOD.prefab"))
                {
                    ...
                    if (ShaderLOD1S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD1Material,
                            T4MPrefabFolder + "LODObjects/Material/" + Next + "LOD1.mat");
                    if (ShaderLOD2S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD2Material,
                            T4MPrefabFolder + "LODObjects/Material/" + Next + "LOD2.mat");
                    if (ShaderLOD3S == LODShaderStatus.New)
                        AssetDatabase.CreateAsset(LOD3Material,
                            T4MPrefabFolder + "LODObjects/Material/" + Next + "LOD3.mat");
...
//        }
        ...
        void ConverterMenu()
        {
            if (vertexInfo == 0 && trisInfo == 0 && partofT4MObj == 0)
            {
                ...
                if ((CurrentSelect.GetComponent<Renderer>() || CurrentSelect.GetComponent<Terrain>() ||
                     NbrPartObj != null && NbrPartObj.Length != 0) && !CurrentSelect.GetComponent<T4MObjSC>() &&
                    !CurrentSelect.GetComponent<T4MPartSC>())
                {
                    GUILayout.BeginHorizontal();
                    GUILayout.FlexibleSpace();
                    if (CurrentSelect.GetComponent<Renderer>() && !CurrentSelect.GetComponent<Terrain>() ||
                        NbrPartObj != null && NbrPartObj.Length != 0 && !CurrentSelect.GetComponent<Terrain>())
                    {
                        if (terrainDat)
                            terrainDat = null;
                ...
                else
                {
                    ...
                    {
                        GUILayout.Label("Can't convert that to T4M Object", EditorStyles.boldLabel);
                    }
                    GUILayout.FlexibleSpace();
                    GUILayout.EndHorizontal();
                }
        ...
        void PainterMenu()
        {
            if (CurrentSelect.GetComponent<T4MObjSC>())
            {
                ...
                switch (MyT4MV)
                {
                    case 0:
                        if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader !=
                            Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M World Projection Shader + LM") &&
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader !=
                            Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M World Projection Shader") &&
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader !=
                            Shader.Find("T4MShaders/ShaderModel2/MobileLM/T4M World Projection Shader_Mobile") &&
                        ...
                        T4MUseOverrideColor = EditorGUILayout.Toggle("UseOverridColorMode", T4MUseOverrideColor);
                        T4MoverrideColor = EditorGUILayout.ColorField("override Color", T4MoverrideColor);
                    ...
                    case 1:
                            ...
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control"))
                        {
                            ...
                            selProcedural = GUILayout.SelectionGrid(selProcedural, TexTexture, 6, "gridlist",
                                GUILayout.Width(340), GUILayout.Height(58));
                                    ...
                                    GUILayout.Width(53)))
                            {
                                ...
                                {
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                        .T4MMaterial.SetTexture("_Splat0", PreceduralAdd.GetTexture("_MainTex"));
                                    if (
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.HasProperty("_BumpSplat0"))
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_BumpSplat0", PreceduralAdd.GetTexture("_BumpMap"));
                                }
                                else if (MaterialAdd)
                                {
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                        .T4MMaterial.SetTexture("_Splat0", MaterialAdd);
                                }
                                selProcedural = 0;
                                PreceduralAdd = null;
                                MaterialAdd = null;
                                    ...
                                    GUILayout.Width(53)))
                            {
                                ...
                                {
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                        .T4MMaterial.SetTexture("_Splat1", PreceduralAdd.GetTexture("_MainTex"));
                                    if (
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.HasProperty("_BumpSplat1"))
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_BumpSplat1", PreceduralAdd.GetTexture("_BumpMap"));
                                }
                                else if (MaterialAdd)
                                {
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                        .T4MMaterial.SetTexture("_Splat1", MaterialAdd);
                                }
                                selProcedural = 1;
                                PreceduralAdd = null;
                                MaterialAdd = null;
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat2"))
                                                ...
                                                typeof(Texture)), GUILayout.Width(53)))
                                {
                                    ...
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat2", PreceduralAdd.GetTexture("_MainTex"));
                                        if (
                                            CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                                .T4MMaterial.HasProperty("_BumpSplat2"))
                                            CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                                .T4MMaterial.SetTexture("_BumpSplat2",
                                                    PreceduralAdd.GetTexture("_BumpMap"));
                                    }
                                    else if (MaterialAdd)
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat2", MaterialAdd);
                                    }
                                    selProcedural = 2;
                                    PreceduralAdd = null;
                                    MaterialAdd = null;
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat3"))
                                                ...
                                                typeof(Texture)), GUILayout.Width(53)))
                                {
                                    ...
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat3", PreceduralAdd.GetTexture("_MainTex"));
                                        if (
                                            CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                                .T4MMaterial.HasProperty("_BumpSplat3"))
                                            CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                                .T4MMaterial.SetTexture("_BumpSplat3",
                                                    PreceduralAdd.GetTexture("_BumpMap"));
                                    }
                                    else if (MaterialAdd)
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat3", MaterialAdd);
                                    }
                                    selProcedural = 3;
                                    PreceduralAdd = null;
                                    MaterialAdd = null;
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat4"))
                                                ...
                                                typeof(Texture)), GUILayout.Width(53)))
                                {
                                    ...
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat4", PreceduralAdd.GetTexture("_MainTex"));
                                    }
                                    else if (MaterialAdd)
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat4", MaterialAdd);
                                    }
                                    selProcedural = 4;
                                    PreceduralAdd = null;
                                    MaterialAdd = null;
                            ...
                            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat5"))
                                                ...
                                                typeof(Texture)), GUILayout.Width(53)))
                                {
                                    ...
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat5", PreceduralAdd.GetTexture("_MainTex"));
                                    }
                                    else if (MaterialAdd)
                                    {
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.SetTexture("_Splat5", MaterialAdd);
                                    }
                                    selProcedural = 5;
                                    PreceduralAdd = null;
                                    MaterialAdd = null;
                            ...
                            string AssetName =
                                AssetDatabase.GetAssetPath(
                                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                        .T4MMaterial.GetTexture("_Splat" + selProcedural)) as string;
                            ...
                            if (SubstanceI)
                            {
                                ...
                                {
                                    if (ProcMat[i].name + "_Diffuse" ==
                                        CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                                            .T4MMaterial.GetTexture("_Splat" + selProcedural)
                                            .name)
                                    {
                            ...
                            MaterialTyp =
                                (MaterialType)
                                    EditorGUILayout.EnumPopup("Material Type", MaterialTyp, GUILayout.Width(340));
                            EditorGUILayout.BeginHorizontal();
        ...
        void ProjectionWorldConfig()
        {
            ...
            CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                .T4MMaterial.SetVector("_Tiling", new Vector4(UpSideTile.x, UpSideTile.y, UpSideTile.z, UpSideTile.w));
                ...
                switch (EnumMyT4MV)
                {
                    case 0:
                        ...
                        if (ShaderModel == SM.ShaderModel1)
                        {
                            MenuTextureSM1 =
                                (EnumShaderGLES1)
                                    EditorGUILayout.EnumPopup("Shader", MenuTextureSM1, GUILayout.Width(340));
                        }
                        else if (ShaderModel == SM.ShaderModel2)
                        {
                            MenuTextureSM2 =
                                (EnumShaderGLES2)
                                    EditorGUILayout.EnumPopup("Shader", MenuTextureSM2, GUILayout.Width(340));
                        }
...
//                            PlayerCam = EditorGUILayout.ObjectField(PlayerCam, typeof(Transform), true) as Transform;
                            ...
                            CurrentSelect.GetComponent<T4MObjSC>().LODPreview =
                                EditorGUILayout.Toggle(CurrentSelect.GetComponent<T4MObjSC>().LODPreview);
                            ...
                            GUILayout.Label("   Editor Preview", EditorStyles.boldLabel, GUILayout.Width(120));
                            CurrentSelect.GetComponent<T4MObjSC>().BillboardPreview =
                                EditorGUILayout.Toggle(CurrentSelect.GetComponent<T4MObjSC>().BillboardPreview);
                            GUILayout.EndHorizontal();
                            ...
                            GUILayout.Label("   Editor Preview", EditorStyles.boldLabel, GUILayout.Width(120));
                            CurrentSelect.GetComponent<T4MObjSC>().LayerCullPreview =
                                EditorGUILayout.Toggle(CurrentSelect.GetComponent<T4MObjSC>().LayerCullPreview);
                            GUILayout.EndHorizontal();
                            EditorGUILayout.Space();
                            if (ActivatedLayerCul)
                            {
                                ...
                                GUILayout.Label("Maximum distances of view", EditorStyles.boldLabel,
                                    GUILayout.Width(220));
                    ...
                    case 1:
                        ...
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().ActiveWind =
                            EditorGUILayout.Toggle(CurrentSelect.gameObject.GetComponent<T4MObjSC>().ActiveWind);
                        GUILayout.EndHorizontal();
                        EditorGUILayout.Space();
                        GUILayout.BeginVertical("box");
                        EditorGUILayout.Space();
                        ...
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().TranslucencyColor =
                            EditorGUILayout.ColorField("Translucency Color ",
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>().TranslucencyColor);
                        EditorGUILayout.Space();
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().Wind =
                            EditorGUILayout.Vector4Field("Wind Vector",
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>().Wind);
                        EditorGUILayout.Space();
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().WindFrequency =
                            EditorGUILayout.Slider("Wind Frequency",
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>().WindFrequency, 0, 5);
                        EditorGUILayout.Space();
                        CurrentSelect.gameObject.GetComponent<T4MObjSC>().GrassWindFrequency =
                            EditorGUILayout.Slider("Grass Wind Frequency",
                                CurrentSelect.gameObject.GetComponent<T4MObjSC>().GrassWindFrequency, 0, 5);
                        EditorGUILayout.Space();
                        GUILayout.BeginHorizontal();
                        GUILayout.FlexibleSpace();
                        if (GUILayout.Button("Reset", GUILayout.Width(100), GUILayout.Height(15)))
                        {
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().TranslucencyColor = new Color(0.73f, 0.85f,
                                0.4f, 1f);
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().Wind = new Vector4(0.85f, 0.075f, 0.4f,
                                0.5f);
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.FlexibleSpace();
                        GUILayout.Label("By Forst (Lars)", EditorStyles.boldLabel, GUILayout.Width(105),
                            GUILayout.Height(15));
                        GUILayout.EndHorizontal();
                        GUILayout.BeginHorizontal();
                        GUILayout.FlexibleSpace();
                        if (GUILayout.Button("Others Assets by Forst", "textarea", GUILayout.Width(140),
                            GUILayout.Height(15)))
                        {
        ...
        void MyT4MApplyChange()
        {
            if (ShaderModel == SM.ShaderModel1)
            {
                ...
                else if (MenuTextureSM1 == EnumShaderGLES1.T4M_2_Textures_ManualAdd_BeastLM_1DC)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures ManualAdd BeastLM_1DC");
                }
                else if (MenuTextureSM1 == EnumShaderGLES1.T4M_2_Textures_ManualAdd_CustoLM_1DC)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures ManualAdd CustoLM 1DC");
                }
            ...
            else if (ShaderModel == SM.ShaderModel2)
            {
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 2 Textures Unlit LM");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_Unlit_Lightmap_Compatible)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 3 Textures Unlit LM");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_4_Textures_Unlit_Lightmap_Compatible)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 4 Textures Unlit LM");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_5_Textures_Unlit_Lightmap_Compatible)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 5 Textures Unlit LM");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_6_Textures_Unlit_Lightmap_Compatible)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 6 Textures Unlit LM");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_6_Textures_Unlit_No_Lightmap)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 6 Textures Unlit NoLM");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M 2 Textures");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_HighSpec)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M 3 Textures");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_4_Textures_HighSpec)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M 4 Textures");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_5_Textures_HighSpec)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M 5 Textures");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_6_Textures_HighSpec)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M 6 Textures");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Specular/T4M 2 Textures Spec");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_Specular)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Specular/T4M 3 Textures Spec");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_4_Textures_Specular)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Specular/T4M 4 Textures Spec");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/MobileLM/T4M 2 Textures for Mobile");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_4_Mobile)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/MobileLM/T4M 3 Textures for Mobile");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_4_Textures_4_Mobile)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/MobileLM/T4M 4 Textures for Mobile");
                }

                //4 mobile lightmap SM2 vertex
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_2_Textures_4_MobileVertex)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/MobileVertex/T4M 2 Textures Test for Mobile");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_4_MobileVertex)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/MobileVertex/T4M 3 Textures Test for Mobile");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_4_Textures_4_MobileVertex)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/MobileVertex/T4M 4 Textures Test for Mobile");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Toon/T4M 2 Textures Toon");
                    Cubemap ToonShade =
                        (Cubemap)
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Toon/T4M 3 Textures Toon");
                    Cubemap ToonShade =
                        (Cubemap)
                            AssetDatabase.LoadAssetAtPath(T4MFolder + "Shaders/Sources/toony lighting.psd",
                                typeof(Cubemap));
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Toon/T4M 4 Textures Toon");
                    Cubemap ToonShade =
                        (Cubemap)
                            AssetDatabase.LoadAssetAtPath(T4MFolder + "Shaders/Sources/toony lighting.psd",
                                typeof(Cubemap));
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bumped");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_Bumped)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 3 Textures Bumped");
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bumped Mobile");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_Bumped_Mobile)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 3 Textures Bumped Mobile");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bump Specular Mobile");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/BumpDLM/T4M 2 Textures Bumped DLM Mobile");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bump Specular");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_Bumped_SPEC)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 3 Textures Bump Specular");
                }
                //Bump LM SM2
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_2_Textures_Bumped_DirectionalLM)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/BumpDLM/T4M 2 Textures Bumped DLM");
                }
                else if (MenuTextureSM2 == EnumShaderGLES2.T4M_3_Textures_Bumped_DirectionalLM)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel2/BumpDLM/T4M 3 Textures Bumped DLM");
                }
            ...
            else if (ShaderModel == SM.ShaderModel3)
            {
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Diffuse/T4M 2 Textures");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_3_Textures_Diffuse)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Diffuse/T4M 3 Textures");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_4_Textures_Diffuse)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Diffuse/T4M 4 Textures");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_5_Textures_Diffuse)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Diffuse/T4M 5 Textures");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_6_Textures_Diffuse)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Diffuse/T4M 6 Textures");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Specular/T4M 2 Textures Spec");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_3_Textures_Specular)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Specular/T4M 3 Textures Spec");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_4_Textures_Specular)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Specular/T4M 4 Textures Spec");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Bump/T4M 2 Textures Bump");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_3_Textures_Bumped)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Bump/T4M 3 Textures Bump");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_4_Textures_Bumped)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/Bump/T4M 4 Textures Bump");
                }
                ...
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/BumpSpec/T4M 2 Textures Bump Spec");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_3_Textures_Bumped_SPEC)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/BumpSpec/T4M 3 Textures Bump Spec");
                }
                else if (MenuTextureSM3 == EnumShaderGLES3.T4M_4_Textures_Bumped_SPEC)
                {
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader =
                        Shader.Find("T4MShaders/ShaderModel3/BumpSpec/T4M 4 Textures Bump Spec");
                }
            ...
            else
            {
                ...
                if (CustomShader != null && temp.HasProperty("_Control") && temp.HasProperty("_Splat0") &&
                    temp.HasProperty("_Splat1"))
                {
...
//                CurrentSelect.GetComponent<T4MObjSC>().PlayerCamera = PlayerCam;
        ...
        void CreateControl2Text()
        {
            ...
            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control") != null)
            {
                path = T4MPrefabFolder + "Terrains/Texture/" +
                       CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control").name +
                       "C2.png";
            ...
            SetTextureFormat(TextureI);
            //      TextureI.textureFormat = TextureImporterFormat.RGBA32;
        ...
        void ConvertUTerrain()
        {
            ...
            AssetDatabase.ImportAsset(T4MPrefabFolder + "Terrains/Material/" + FinalExpName + ".mat",
            ...
            FileUtil.CopyFileOrDirectory(FinalExpName + ".obj",
                T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj");
            FileUtil.DeleteFileOrDirectory(FinalExpName + ".obj");



            //Force Update
            AssetDatabase.ImportAsset(T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj",
                ImportAssetOptions.ForceUpdate);
            ...
            GameObject BasePrefab2 = PrefabUtility.CreatePrefab(
            ...
            ModelImporter OBJI =
                ModelImporter.GetAtPath(T4MPrefabFolder + "Terrains/Meshes/" + FinalExpName + ".obj") as ModelImporter;
            OBJI.globalScale = 1;
        ...
        void Obj2T4M()
        {
            ...
            File.WriteAllBytes(path, data);
            AssetDatabase.ImportAsset(path, ImportAssetOptions.ForceUpdate);
            var TextureIm = TextureImporter.GetAtPath(path) as TextureImporter;
            SetTextureFormat(TextureIm);
            AssetDatabase.ImportAsset(path, ImportAssetOptions.ForceUpdate);

            //aorition hacked
            var path2 = T4MPrefabFolder + "Terrains/Texture/" + FinalExpName + "_oc.png";
            var data2 = NewOCTex.EncodeToPNG();
            File.WriteAllBytes(path2, data2);
            AssetDatabase.ImportAsset(path2, ImportAssetOptions.ForceUpdate);
            var TextureIm2 = TextureImporter.GetAtPath(path2) as TextureImporter;
            SetTextureFormat(TextureIm2);
            AssetDatabase.ImportAsset(path2, ImportAssetOptions.ForceUpdate);

            Material Tmaterial;
            //        Tmaterial = new Material(Shader.Find("T4MShaders/ShaderModel2/Diffuse/T4M 4 Textures"));
            if (index >= 0 && index < _DefineShaderNames.Length)
            {
                Tmaterial = new Material(Shader.Find(_DefineShaderNames[index]));
            }
            else
            {
                Tmaterial = new Material(Shader.Find(_DefineShaderNames[0]));
            }
            ...
            else
            {
                ...
                CurrentSelect.gameObject.GetComponent<Renderer>().material =
            ...
            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial = Tmaterial;
            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.SetTexture("_Control", FinalCtlTex);
            //aorition hacked
            ...
            {
                UnityEngine.Object BasePrefab =
                    PrefabUtility.CreateEmptyPrefab(T4MPrefabFolder + "Terrains/" + FinalExpName + ".prefab");
        ...
        private static void SetTextureFormat(TextureImporter TextureIm)
        {
#if UNITY_5_6
        ...
        void IniNewSelect()
        {
                ...
                CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial)
            {
                ...
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat0"))
                {
                    ...
                    Layer1Tile = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetTextureScale("_Splat0");
                }
                else Layer1 = null;
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat1"))
                {
                    Layer2 = CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat1");
                    Layer2Tile = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetTextureScale("_Splat1");
                }
                else Layer2 = null;
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat2"))
                {
                    Layer3 = CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat2");
                    Layer3Tile = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetTextureScale("_Splat2");
                }
                else Layer3 = null;
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat3"))
                {
                    Layer4 = CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat3");
                    Layer4Tile = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetTextureScale("_Splat3");
                }
                else Layer4 = null;
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat4"))
                {
                    Layer5 = CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat4");
                    Layer5Tile = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetTextureScale("_Splat4");
                }
                else Layer5 = null;
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Splat5"))
                {
                    Layer6 = CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Splat5");
                    Layer6Tile = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetTextureScale("_Splat5");
                }
                else Layer6 = null;
                ...
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_BumpSplat0"))
                {
                    ...
                    if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_BumpSplat2"))
                        Layer3Bump =
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_BumpSplat2");
                    if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_BumpSplat3"))
                        Layer4Bump =
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_BumpSplat3");
...
//                PlayerCam = CurrentSelect.GetComponent<T4MObjSC>().PlayerCamera;
                ...
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().BillboardPosition != null &&
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().BillboardPosition.Length > 0)
                    billActivate = true;
                else billActivate = false;

                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().ObjPosition != null &&
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().ObjPosition.Length > 0)
                    LodActivate = true;
...
//                }
                ...
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_SpecColor"))
                {
                    ...
                    {
                        shiness0 = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                            .T4MMaterial.GetFloat("_ShininessL0");
                    }
                    if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_ShininessL1"))
                    {
                        shiness1 = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                            .T4MMaterial.GetFloat("_ShininessL1");
                    }
                    if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_ShininessL2"))
                    {
                        shiness2 = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                            .T4MMaterial.GetFloat("_ShininessL2");
                    }
                    if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_ShininessL3"))
                    {
                        shiness3 = CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                            .T4MMaterial.GetFloat("_ShininessL3");
                    }
                }
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_Control2") &&
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control2"))
                    T4MMaskTex2 =
                        (Texture2D)
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_Control2");
                ...
                //aorition hacked 
                if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.HasProperty("_OverColor"))
                {
                    T4MOColorTex =
                        (Texture2D)
                            CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.GetTexture("_OverColor");
                }
                else
                {
                    T4MOColorTex = null;
        ...
        void CheckShader()
        {
            ...
            else if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                     Shader.Find("T4MShaders/ShaderModel1/T4M 2 Textures ManualAdd BeastLM_1DC"))
            {
                     ...
                     Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 6 Textures Unlit LM"))
            {
                ...
                ShaderModel = SM.ShaderModel2;
                     ...
                     Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 6 Textures Unlit NoL"))
            {
                ...
                CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Unlit/T4M World Projection Shader + LM"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2.T4M_World_Projection_Unlit_Lightmap_Compatible;
                ShaderModel = SM.ShaderModel2;
                UpSideTile =
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetVector("_Tiling");
                UpSideF =
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetFloat("_UpSide");
                BlendFac =
                    CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                        .T4MMaterial.GetFloat("_Blend");
            ...
            {
                MenuTextureSM2 =
                    EnumShaderGLES2.T4M_5_Textures_HighSpec;
                ShaderModel = SM.ShaderModel2;
            }
            else if (
                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
            ...
            {
                MenuTextureSM2 =
                    EnumShaderGLES2.T4M_6_Textures_HighSpec;
                ShaderModel = SM.ShaderModel2;
            }
            else if (
                CurrentSelect.gameObject
                    .GetComponent<T4MObjSC>()
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Diffuse/T4M World Projection Shader"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_World_Projection_HighSpec;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Specular/T4M 2 Textures Spec"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_2_Textures_Specular;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Specular/T4M 3 Textures Spec"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_3_Textures_Specular;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Specular/T4M 4 Textures Spec"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_4_Textures_Specular;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/MobileLM/T4M 2 Textures for Mobile"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_2_Textures_4_Mobile;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/MobileLM/T4M 3 Textures for Mobile"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_3_Textures_4_Mobile;
                ...
                CurrentSelect
                    ...
                    .shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/MobileLM/T4M 4 Textures for Mobile"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_4_Textures_4_Mobile;
            ...
            if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                Shader.Find("T4MShaders/ShaderModel2/MobileVertex/T4M 2 Textures Test for Mobile"))
            {
                MenuTextureSM2 = EnumShaderGLES2.T4M_2_Textures_4_MobileVertex;
                ShaderModel = SM.ShaderModel2;
            }
            else if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                     Shader.Find("T4MShaders/ShaderModel2/MobileVertex/T4M 3 Textures Test for Mobile"))
            {
                MenuTextureSM2 = EnumShaderGLES2.T4M_3_Textures_4_MobileVertex;
                ShaderModel = SM.ShaderModel2;
            }
            else if (CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                     Shader.Find("T4MShaders/ShaderModel2/MobileVertex/T4M 4 Textures Test for Mobile"))
            {
                MenuTextureSM2 = EnumShaderGLES2.T4M_4_Textures_4_MobileVertex;
                ShaderModel = SM.ShaderModel2;
            }
            //else
		...
		if (CurrentSelect.gameObject.GetComponent <T4MObjSC>().T4MMaterial.shader == Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 4 Textures Bumped")){
                     ...
                     Shader.Find("T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bumped Mobile"))
            {
                ...
                CurrentSelect.gameObject.GetComponent<T4MObjSC>().T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Bump/T4M 3 Textures Bumped Mobile"))
            {
                ...
                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bump Specular Mobile"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2.T4M_2_Textures_Bumped_SPEC_Mobile;
                ShaderModel = SM.ShaderModel2;
            }
            else if (
                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/BumpDLM/T4M 2 Textures Bumped DLM Mobile"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_2_Textures_Bumped_DirectionalLM_Mobile;
                ...
                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Bump/T4M 2 Textures Bump Specular"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2.T4M_2_Textures_Bumped_SPEC;
                ShaderModel = SM.ShaderModel2;
            }
            else if (
                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/Bump/T4M 3 Textures Bump Specular"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2.T4M_3_Textures_Bumped_SPEC;
                ShaderModel = SM.ShaderModel2;
            }
            else if (
                CurrentSelect.gameObject.GetComponent<T4MObjSC>()
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/BumpDLM/T4M 2 Textures Bumped DLM"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_2_Textures_Bumped_DirectionalLM;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel2/BumpDLM/T4M 3 Textures Bumped DLM"))
            {
                MenuTextureSM2 =
                    EnumShaderGLES2
                        .T4M_3_Textures_Bumped_DirectionalLM;
                    ...
                    "T4MShaders/ShaderModel3/Diffuse/T4M 2 Textures"))
            {
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel3/Diffuse/T4M 3 Textures"))
            {
                MenuTextureSM3 =
                    EnumShaderGLES3
                        .T4M_3_Textures_Diffuse;
                    ...
                    "T4MShaders/ShaderModel3/Diffuse/T4M 3 Textures"))
            {
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel3/Diffuse/T4M 4 Textures"))
            {
                MenuTextureSM3 =
                    EnumShaderGLES3
                        .T4M_4_Textures_Diffuse;
                ...
                CurrentSelect.gameObject
                    ...
                    .T4MMaterial.shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel3/Diffuse/T4M 5 Textures"))
            {
                MenuTextureSM3 =
                    EnumShaderGLES3
                        .T4M_5_Textures_Diffuse;
                ...
                CurrentSelect
                    ...
                    .shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel3/Diffuse/T4M 6 Textures"))
            {
                MenuTextureSM3 =
                    EnumShaderGLES3
                        .T4M_6_Textures_Diffuse;
                ...
                CurrentSelect
                    ...
                    .shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel3/Specular/T4M 2 Textures Spec"))
            {
                MenuTextureSM3 =
                    EnumShaderGLES3
                        .T4M_2_Textures_Specular;
                ...
                CurrentSelect
                    ...
                    .shader ==
                Shader.Find(
                    "T4MShaders/ShaderModel3/Specular/T4M 3 Textures Spec"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/Specular/T4M 4 Textures Spec"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/Bump/T4M 2 Textures Bump"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/Bump/T4M 3 Textures Bump"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/Bump/T4M 4 Textures Bump"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/BumpSpec/T4M 2 Textures Bump Spec"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/BumpSpec/T4M 3 Textures Bump Spec"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
                ...
                Shader
                    .Find
                    ("T4MShaders/ShaderModel3/BumpSpec/T4M 4 Textures Bump Spec"))
            {
                MenuTextureSM3
                    =
                    EnumShaderGLES3
