...
namespace T4MLite
{
    ...
    {
        [HideInInspector] public string ConvertType = "";
        [HideInInspector] public bool EnabledLODSystem = true;
        [HideInInspector] public Vector3[] ObjPosition;
        [HideInInspector] public T4MLodObjSC[] ObjLodScript;
        [HideInInspector] public int[] ObjLodStatus; //0=Occlude // 1=LOD1 // 2=LOD=2 // 3=LOD3
        [HideInInspector] public float MaxViewDistance = 60.0f;
...
//        [HideInInspector] public Transform PlayerCamera;
        ...
        [HideInInspector] public bool enabledBillboard = true;
        [HideInInspector] public Vector3[] BillboardPosition;
        [HideInInspector] public float BillInterval = 0.05f;
        [HideInInspector] public int[] BillStatus; //0=Occlude // 1=Active
        [HideInInspector] public float BillMaxViewDistance = 30.0f;
        [HideInInspector] public T4MBillBObjSC[] BillScript;
        [HideInInspector] public bool enabledLayerCul = true;
        [HideInInspector] public float BackGroundView = 1000f;
        [HideInInspector] public float FarView = 200.0f;
        [HideInInspector] public float NormalView = 60.0f;
        [HideInInspector] public float CloseView = 30.0f;
        float[] distances = new float[32];
        [HideInInspector] public int Axis = 0;
        [HideInInspector] public bool LODbasedOnScript = true;
        [HideInInspector] public bool BilBbasedOnScript = true;

        public Material T4MMaterial;
        public MeshFilter T4MMesh;

        //ATS
        [HideInInspector] public Color TranslucencyColor = new Color(0.73f, 0.85f, 0.4f, 1f);
        [HideInInspector] public Vector4 Wind = new Vector4(0.85f, 0.075f, 0.4f, 0.5f);
        [HideInInspector] public float WindFrequency = 0.75f;
        [HideInInspector] public float GrassWindFrequency = 1.5f;
        [HideInInspector] public bool ActiveWind = false;
