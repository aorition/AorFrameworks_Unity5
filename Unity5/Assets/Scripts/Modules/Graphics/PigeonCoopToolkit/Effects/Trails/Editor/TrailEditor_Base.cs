...
namespace PigeonCoopToolkit.Effects.Trails.Editor
{
    ...
    public class TrailEditor_Base : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            float defaultLabelWidth = UnityEditor.EditorGUIUtility.labelWidth;
            float defaultFieldWidth = UnityEditor.EditorGUIUtility.fieldWidth;
            GUILayout.Space(5);
            ...
            UnityEditor.EditorGUIUtility.labelWidth = defaultLabelWidth;
            UnityEditor.EditorGUIUtility.fieldWidth = defaultFieldWidth;
            

            GUILayout.BeginHorizontal();
            UnityEditor.EditorGUIUtility.fieldWidth = defaultLabelWidth - 80;
            ...
            if (!ExcludedDefaultPropties.Contains("TrailData.ColorOverLife"))
            {
                ...
                {
                    UnityEditor.EditorGUIUtility.fieldWidth = (defaultFieldWidth - 80)/2f;
