...
namespace YoukiaUnity.CinemaSystem
{
    ...
    /// 角色:制作时的点位
    /// </summary>
    public class CinemaCharacter : MonoBehaviour
    {
...
//        [HideInInspector]
    ...
    /// *** 注意： 
    /// 
    /// 运行时需要使用AnimationClipConfig配置表作为公共角色动作定义表， 请在运行时设置CinemaRTBActorBehavior.UseAnimationClipConfig = true, 并填充CinemaRTBActorBehavior.AnimationClipConfigDic；
    /// 
    /// </summary>
