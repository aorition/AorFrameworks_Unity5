...
//    [MenuItem("Youkia/CinemaSystem/CinemaEventEditor")]
    public static void init(AnimationClip clip, Type brigdeType)
    {
        CinemaEventsWindow w = EditorWindow.GetWindow<CinemaEventsWindow>();
        w.minSize = new Vector2(480,430);
        w.setup(clip, brigdeType);
    }

    public static void init(AnimationClip clip, Type brigdeType, EditorWindow animationWindow)
    {
        CinemaEventsWindow w = EditorWindow.GetWindow<CinemaEventsWindow>();
        w.minSize = new Vector2(480, 430);
        w.setup(clip, brigdeType, animationWindow);
    }
...
//        }
    ...
    public void setup(AnimationClip clip, Type brigdeType)
    {
        _cilp = clip;
    ...
    public void setup(AnimationClip clip, Type brigdeType, EditorWindow animationWindow)
    {
        _animationWindow = animationWindow;
        setup(clip, brigdeType);
    }
    ...
    private void OnGUI()
    {
        ...
        if (_animationWindow != null)
        {
            ...
            FieldInfo currentTime = state.FieldType.GetField("m_CurrentTime",
