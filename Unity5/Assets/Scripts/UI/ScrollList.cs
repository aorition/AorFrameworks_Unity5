...
namespace UnityEngine.UI
{
    ...
    public class ScrollList : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        [SerializeField]
        private UGUI_ScrollRect_SC.MovementType m_MovementType = UGUI_ScrollRect_SC.MovementType.Elastic;
        public UGUI_ScrollRect_SC.MovementType movementType { get { return m_MovementType; } set { m_MovementType = value; } }
        ...
        [SerializeField]
        private UGUI_ScrollRect_SC.ScrollbarVisibility m_HorizontalScrollbarVisibility;
        public UGUI_ScrollRect_SC.ScrollbarVisibility horizontalScrollbarVisibility { get { return m_HorizontalScrollbarVisibility; } set { m_HorizontalScrollbarVisibility = value; SetDirtyCaching(); } }

        [SerializeField]
        private UGUI_ScrollRect_SC.ScrollbarVisibility m_VerticalScrollbarVisibility;
        public UGUI_ScrollRect_SC.ScrollbarVisibility verticalScrollbarVisibility { get { return m_VerticalScrollbarVisibility; } set { m_VerticalScrollbarVisibility = value; SetDirtyCaching(); } }
        ...
        [SerializeField]
        private UGUI_ScrollRect_SC.ScrollRectEvent m_OnValueChanged = new UGUI_ScrollRect_SC.ScrollRectEvent();
        public UGUI_ScrollRect_SC.ScrollRectEvent onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
        ...
        void UpdateCachedData()
        {
            ...
            m_HSliderExpand = allAreChildren && m_HorizontalScrollbarRect && horizontalScrollbarVisibility == UGUI_ScrollRect_SC.ScrollbarVisibility.AutoHideAndExpandViewport;
            m_VSliderExpand = allAreChildren && m_VerticalScrollbarRect && verticalScrollbarVisibility == UGUI_ScrollRect_SC.ScrollbarVisibility.AutoHideAndExpandViewport;
        ...
        public virtual void OnScroll(PointerEventData data)
        {
            ...
            if (m_MovementType == UGUI_ScrollRect_SC.MovementType.Clamped)
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            position += offset;
            if (m_MovementType == UGUI_ScrollRect_SC.MovementType.Elastic)
            {
                if (offset.x != 0)
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (!m_Dragging && (offset != Vector2.zero || m_Velocity != Vector2.zero))
            {
                ...
                for (int axis = 0; axis < 2; axis++)
                {
                    ...
                    if (m_MovementType == UGUI_ScrollRect_SC.MovementType.Elastic && offset[axis] != 0)
                    {
        ...
        private static void UpdateOneScrollbarVisibility(bool xScrollingNeeded, bool xAxisEnabled, UGUI_ScrollRect_SC.ScrollbarVisibility scrollbarVisibility, Scrollbar scrollbar)
        {
            if (scrollbar)
            {
                if (scrollbarVisibility == UGUI_ScrollRect_SC.ScrollbarVisibility.Permanent)
                {
        ...
        protected void UpdateBounds()
        {
            ...
            if (movementType == UGUI_ScrollRect_SC.MovementType.Clamped)
            {
        ...
        internal static Vector2 InternalCalculateOffset(ref Bounds viewBounds, ref Bounds contentBounds, bool horizontal, bool vertical, UGUI_ScrollRect_SC.MovementType movementType, ref Vector2 delta)
        {
            Vector2 offset = Vector2.zero;
            if (movementType == UGUI_ScrollRect_SC.MovementType.Unrestricted)
                return offset;
