...
Shader"Custom/NoLight/Unlit-Color##"{
	...
	_TintColor("Color",Color) = (1,1,1,1)
		...
		[Enum(UnityEngine.Rendering.BlendMode)]_srcAlphaBlend("SrcAlphaBlendMode",Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)]_dstAlphaBlend("DstAlphaBlendMode",Float) = 10
