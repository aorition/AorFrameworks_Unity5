...
namespace Framework.Editor.Utility
{
    ...
    public class MeshStatisticsTool : EditorWindow
    {
        ...
        [MenuItem("FrameworkTools/辅助工具/Mesh数据统计工具")]
        ...
        protected void OnGUI()
        {
            ...
            List<MeshFilter> mfList = _TargetMeshRoot.transform.FindComponentListInChildren<MeshFilter>(true);
            int MeshFilterNum = 0;
            ...
            List<SkinnedMeshRenderer> smrList = _TargetMeshRoot.transform.FindComponentListInChildren<SkinnedMeshRenderer>(true);
            ...
            List<SpriteRenderer> srList = _TargetMeshRoot.transform.FindComponentListInChildren<SpriteRenderer>(true);
