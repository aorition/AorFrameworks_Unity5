...
namespace Framework.NodeGraph
{
    ...
    public class AssetBundleSeceneBuilderGUIController : NodeGUIController
    {
        ...
        {
            return NodeGraphLagDefind.Get("seceneBuilder");
        }
...
//        }
        ...
        public override void DrawNodeInspector(float inspectorWidth)
        {
            ...
            //BuildOptions
            NodeGraphUtility.Draw_NG_EnumPopup<BuildOptions>(m_nodeGUI.data, "BOEnum", new GUIContent("BuildOptions"));
