...
//    [InitializeOnLoad]
//    internal sealed class GMVSettings
//    {
//        public static class GMVCoreSettings
//        {
...
//                EditorGUI.BeginChangeCheck();
//                Color newActiveGizmoColour = EditorGUILayout.ColorField(sCoreActiveGizmosColour, GMVCoreSettings.ActiveGizmoColour);
//
//                if (EditorGUI.EndChangeCheck())
//                {
//                    GMVCoreSettings.ActiveGizmoColour = newActiveGizmoColour;
//                    UnityEditorInternal.InternalEditorUtility.RepaintAllViews();
//                }
//
//                if (GUILayout.Button("Reset"))
//                {
//                    GMVCoreSettings.ActiveGizmoColour = GMVCoreSettings.kDefaultActiveColour;
//                }
//                EditorGUILayout.EndHorizontal();
//
//                EditorGUILayout.BeginHorizontal();
//                EditorGUI.BeginChangeCheck();
//                Color newInactiveGizmoColour = EditorGUILayout.ColorField(sCoreInactiveGizmosColour, GMVCoreSettings.InactiveGizmoColour);
//
//                if (EditorGUI.EndChangeCheck())
//                {
//                    GMVCoreSettings.InactiveGizmoColour = newInactiveGizmoColour;
//                    UnityEditorInternal.InternalEditorUtility.RepaintAllViews();
//                }
//
//                if (GUILayout.Button("Reset"))
//                {
//                    GMVCoreSettings.InactiveGizmoColour = GMVCoreSettings.kDefaultInactiveColour;
//                }
//                EditorGUILayout.EndHorizontal();
//                EditorGUI.indentLevel--;
//            }
