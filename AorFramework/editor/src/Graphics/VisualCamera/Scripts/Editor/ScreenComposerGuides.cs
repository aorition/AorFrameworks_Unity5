...
{
    internal class ScreenComposerGuides
    {
...
//
//            Color hardBarsColour = GMVSettings.ComposerSettings.HardBoundsOverlayColour;
//            Color softBarsColour = GMVSettings.ComposerSettings.SoftBoundsOverlayColour;
//            float overlayOpacity = GMVSettings.ComposerSettings.OverlayOpacity;
//            if (!isLive)
//            {
//                softBarsColour = GMVSettings.GMVCoreSettings.InactiveGizmoColour;
