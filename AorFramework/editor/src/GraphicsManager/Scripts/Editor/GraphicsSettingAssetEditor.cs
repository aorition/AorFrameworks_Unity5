...
public class GraphicsSettingAssetEditor : Editor {

    [MenuItem("Assets/GraphicsManagerAssets/GraphicsSettingAsset")]
    public static void CreateAsset()
    {

        GraphicsSettingAsset info = ScriptableObject.CreateInstance<GraphicsSettingAsset>();
        string dir;
        string name = "unameGraphicsSettingAsset.asset";
