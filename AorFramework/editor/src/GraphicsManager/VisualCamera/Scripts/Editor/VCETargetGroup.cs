...
{
    [CustomEditor(typeof(VCETargetGroup))]
    internal sealed class VCETargetGroupEditor : BaseEditor<VCETargetGroup>
    {
        ...
        void SetupTargetList()
        {
            ...
            VCETargetGroup.Target def = new VCETargetGroup.Target();
