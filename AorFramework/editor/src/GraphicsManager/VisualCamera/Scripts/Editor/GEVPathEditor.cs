...
{
    [CustomEditor(typeof(GEVPath))]
    internal sealed class GEVPathEditor : BaseEditor<GEVPath>
    {
        ...
        void DrawWaypointEditor(Rect rect, int index)
        {
            ...
            GEVPath.Waypoint def = new GEVPath.Waypoint();
            ...
            if (GUI.Button(r, buttonContent, style))
            {
                ...
                GEVPath.Waypoint wp = Target.m_Waypoints[index];
            ...
            if (GUI.Button(r, buttonContent, style))
            {
                ...
                var list = new List<GEVPath.Waypoint>(Target.m_Waypoints);
                list.RemoveAt(index);
        ...
        internal static void DrawPathGizmo(GEVPathBase path, Color pathColor)
        {
            // Draw the path
        ...
        [DrawGizmo(GizmoType.Active | GizmoType.NotInSelectionHierarchy
             | GizmoType.InSelectionHierarchy | GizmoType.Pickable, typeof(GEVPath))]
        static void DrawGizmos(GEVPath path, GizmoType selectionType)
        {
            DrawPathGizmo(path, 
