...
{
    [CustomEditor(typeof(GEVSmoothPath))]
    internal sealed class GEVSmoothPathEditor : BaseEditor<GEVSmoothPath>
    {
        ...
        void DrawWaypointEditor(Rect rect, int index)
        {
            ...
            GEVSmoothPath.Waypoint def = new GEVSmoothPath.Waypoint();
            ...
            if (GUI.Button(r, setButtonContent, GUI.skin.label))
            {
                ...
                GEVSmoothPath.Waypoint wp = Target.m_Waypoints[index];
        ...
        void InsertWaypointAtIndex(int indexA)
        {
            ...
            var wp = new GEVSmoothPath.Waypoint();
            wp.position = pos;
            wp.roll = roll;
            var list = new List<GEVSmoothPath.Waypoint>(Target.m_Waypoints);
        ...
        {
            GEVSmoothPath.Waypoint wp = Target.m_Waypoints[i];
            EditorGUI.BeginChangeCheck();
        ...
        [DrawGizmo(GizmoType.Active | GizmoType.NotInSelectionHierarchy
             | GizmoType.InSelectionHierarchy | GizmoType.Pickable, typeof(GEVSmoothPath))]
        static void DrawGizmos(GEVSmoothPath path, GizmoType selectionType)
        {
            GEVPathEditor.DrawPathGizmo(path, 
