	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert(appdata v)
			{
				...
				o.uv1 = v.uv + _BlurRadius * _TexSize * float2(1, 1);
				o.uv2 = v.uv + _BlurRadius * _TexSize * float2(-1, 1);
				o.uv3 = v.uv + _BlurRadius * _TexSize * float2(-1, -1);
				o.uv4 = v.uv + _BlurRadius * _TexSize * float2(1, -1);
