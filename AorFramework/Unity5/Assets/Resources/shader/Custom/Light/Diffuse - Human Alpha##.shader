...
Shader "Custom/Light/Diffuse - Human Alpha##" {
	...
	Pass {
	 ...
	 //@@@DynamicShaderBlendRepaceEnd
		...
		//	#pragma multi_compile_fwdbase  
			...
			fixed alphaValue = tex2D(_AlphaTex, i.texcoord).rgb;
			...
			float3 spLight = pow(clamp(max(dot(i.normal, normalize(i.eyeDir + _DirectionalLightDir.rgb)), 0), 0, 0.98), max(1,_specularRange))*_specularPower*_DirectionalLightDir.w * _DirectionalLightColor.xyz;
