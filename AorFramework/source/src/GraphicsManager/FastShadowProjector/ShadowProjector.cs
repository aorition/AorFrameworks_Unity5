...
namespace Framework.Graphic.FastShadowProjector
{
    ...
    public class ShadowProjector : MonoBehaviour, IProjector
    {
        ...
        public FastShadowProjectorManager.ShadowType Type { get { return FastShadowProjectorManager.ShadowType.FuzzyProjection; } }
        ...
        public Vector3 GlobalProjectionDir
        {
            set
            {
                ...
                if(FastShadowProjectorManager.Instance)
        ...
        public FastShadowProjectorManager.ProjectionCulling GlobalShadowCullingMode
        {
            set
            {
                ...
                if(FastShadowProjectorManager.Instance)
                    FastShadowProjectorManager.Instance.GlobalShadowCullingMode = _GlobalShadowCullingMode;
        ...
        [UnityEngine.SerializeField]
        protected FastShadowProjectorManager.ProjectionCulling _GlobalShadowCullingMode;
        ...
        public float GlobalCutOffDistance
        {
            set
            {
                ...
                if(FastShadowProjectorManager.Instance)
                    FastShadowProjectorManager.Instance.GlobalCutOffDistance = _GlobalCutOffDistance;
        ...
        void Awake()
        {
            ...
            _ShadowDummy.gameObject.layer = LayerMask.NameToLayer(FastShadowProjectorManager.GlobalProjectorLayer);
