...
namespace Framework.Graphic
{
    ...
    public class TrackedDolly : VisualCameraComponentBase
    {
        ...
        public GEVPathBase.PositionUnits m_PositionUnits = GEVPathBase.PositionUnits.PathUnits;
        ...
        public override void MutateCameraState(float deltaTime)
        {
            ...
            if (m_AutoDolly.m_Enabled && FollowTarget != null)
            {
                ...
                if (m_PositionUnits == GEVPathBase.PositionUnits.Distance)
            ...
            extension.RawPosition = m_PreviousCameraPosition = newCameraPos;

            // Set the orientation and up
            Quaternion newOrientation
                = GetTargetOrientationAtPathPoint(newPathOrientation, extension.ReferenceUp);
            if (deltaTime < 0)
            ...
            extension.RawOrientation = newOrientation;
            extension.ReferenceUp = extension.RawOrientation * Vector3.up;
