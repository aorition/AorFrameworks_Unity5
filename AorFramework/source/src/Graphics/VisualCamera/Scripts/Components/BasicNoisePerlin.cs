...
namespace Framework.Graphic
{
    ...
    public class BasicNoisePerlin : VisualCameraComponentBase, IVisualCameraNoiseComponent
    {
        /// <summary>
        ...
        public override bool IsValid { get { return this != null && enabled && m_NoiseProfile != null; } }
        ...
        public override void MutateCameraState(float deltaTime)
        {
            ...
            extension.PositionCorrection += extension.CorrectedOrientation * GetCombinedFilterResults(
            ...
            extension.OrientationCorrection = extension.OrientationCorrection * rotNoise;
