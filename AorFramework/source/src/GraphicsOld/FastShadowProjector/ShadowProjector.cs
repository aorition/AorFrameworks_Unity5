    ...
    public class ShadowProjector : MonoBehaviour, IProjector
    {
        ...
        private static class MeshGen
        {
            ...
            public static Mesh CreatePlane(Vector3 up, Vector3 right, Rect uvRect, Color color)
            {
                ...
                int[] indices = new int[] { 0, 3, 1, 0, 2, 3 };
        ...
        public Vector3 GlobalProjectionDir
        {
            set
            {
                ...
                //                YKApplication.Instance.GetManager<GraphicsManager>().ShadowMgr.GlobalProjectionDir = _GlobalProjectionDir;
                _graphicsManager.ShadowMgr.GlobalProjectionDir = _GlobalProjectionDir;
        ...
        public int GlobalShadowResolution
        {
            set
            {
                ...
                //                YKApplication.Instance.GetManager<GraphicsManager>().ShadowMgr.GlobalShadowResolution = _GlobalShadowResolution;
                _graphicsManager.ShadowMgr.GlobalShadowResolution = _GlobalShadowResolution;
        ...
        public GlobalProjectorManager.ProjectionCulling GlobalShadowCullingMode
        {
            set
            {
                ...
                //                YKApplication.Instance.GetManager<GraphicsManager>().ShadowMgr.GlobalShadowCullingMode = _GlobalShadowCullingMode;
                _graphicsManager.ShadowMgr.GlobalShadowCullingMode = _GlobalShadowCullingMode;
        ...
        public float GlobalCutOffDistance
        {
            set
            {
                ...
                //                YKApplication.Instance.GetManager<GraphicsManager>().ShadowMgr.GlobalCutOffDistance = _GlobalCutOffDistance;
                _graphicsManager.ShadowMgr.GlobalCutOffDistance = _GlobalCutOffDistance;
        ...
        public Material _Material = GraphicsManager.GetInstance().ShadowMgr.PreShadowMaterial;
        ...
        void Start()
        {
            //           YKApplication.Instance.GetManager<GraphicsManager>().ShadowMgr.AddProjector(this);
            _graphicsManager.ShadowMgr.AddProjector(this);
...
//               YKApplication.Instance.GetManager<GraphicsManager>().ShadowMgr.RemoveProjector(this);
            _graphicsManager.ShadowMgr.RemoveProjector(this);
                if (_ShadowDummy != null)
                {
                    _Renderer.enabled = false;
                }
