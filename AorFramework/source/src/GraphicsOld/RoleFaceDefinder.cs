...
{
    public class RoleFaceDefinder : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (renderer)
            {
                ...
                {
                    Log.error("RoleFaceDefinder.OnEnable Error : renderer.material == null");
                }
            }
            else
            {
                Log.error("RoleFaceDefinder.OnEnable Error : can not find Renderer in " + transform.getHierarchyPath());
            }
