...
namespace YoukiaUnity.View
{
    ...
    public class PivotPointData : MonoBehaviour
    {
        ...
        public void TryFindDefaultPoints()
        {
            ...
            //hurt
            Transform hurt0 = transform.Find("namePoint/namePoint");
            if (hurt0 != null)
            {
        ...
        public UnityEngine.Object GetPivot(int PivotId)
        {
            ...
            {
                Log.warning("*** PivotPointData.getPivot Error : PivotId overflowed the dataList. PivotId = " + PivotId + " , dataList.Count = " + _dataList.Count);
                return null;
            }
        }
