...
{
    public class AssetMaterialProcessorController : NodeController
    {
            ...
            if (clist != null)
            {
                ...
                if (inputPathList.Count > 0)
                {
                    ...
                    for (i = 0; i < len; i++)
                    {
                        ...
                        Material  go = AssetDatabase.LoadAssetAtPath<Material >(inputPathList[i]);
                        if (go)
                        {
                            ...
                            {
                                n1 = false;
                                if ((bool)PreActionMI.Invoke(PreActionTarget, new object[] { actionID, go,m_nodeGUI .data , resultInfoList }))
                                {
